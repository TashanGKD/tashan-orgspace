...
**Files:** Create `apps/api/migrations/013_notifications.sql`, `packages/contracts/src/notifications.ts`, `apps/api/src/notifications/notification-policy-service.ts`, `apps/api/test/notifications/notification-policy.integration.test.ts`.
