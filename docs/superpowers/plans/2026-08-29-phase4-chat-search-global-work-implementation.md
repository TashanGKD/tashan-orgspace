...
**Files:** Create `apps/api/migrations/015_chat.sql`, `packages/contracts/src/chat.ts`, `apps/api/src/chat/chat-authorization.ts`, `apps/api/src/chat/chat-service.ts`, `apps/api/test/chat/chat-service.integration.test.ts`.
...
**Files:** Create `apps/api/migrations/016_search.sql`, `packages/contracts/src/search.ts`, `apps/api/src/search/search-service.ts`, `apps/api/src/search/providers/`, `apps/api/test/search/search-inference.integration.test.ts`.
